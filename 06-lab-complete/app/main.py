"""Compatibility entrypoint exposing the Flask app used in this lab.

This file exists to satisfy the Day 12 delivery structure while keeping
runtime behavior unchanged for the current deployment command.
"""
...
def _load_legacy_flask_app():
    ...
    spec = spec_from_file_location("lab06_legacy_app", module_path)
    if spec is None or spec.loader is None:
        raise RuntimeError(f"Cannot load Flask app from {module_path}")
